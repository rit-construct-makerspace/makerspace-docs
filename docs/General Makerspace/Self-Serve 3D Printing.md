...
The General Makerspace is home to the SHED's main print farm. Students, faculty, and staff can use these 3D printers for personal, club, academic, research, and entrepreneurial projects. These printers can print in single-color PLA, a corn-based bioplastic. Additionally, as of Fall 2025, a few PETG printers are available. PETG is a stronger, more flexible plastic that is traditionally used to make water bottles and similar. 
...
Some machines are additionally set up with PETG, a stronger plastic for engineering and load-bearing applications.
